...
Header file: 
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Src.h
\end{lstlisting}

Code for executing C file: 
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q1-1.c
\end{lstlisting}

When executed, the $10^6$ random numbers will be generated and be sent into to new file called "uni.dat".
...
\end{align}
\\
\solution  The following code plots Fig. 1.2
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q1-2.py
\end{lstlisting}
\begin{figure}[!h]
\centering
...
C file: 
\begin{lstlisting}
https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q1-4.c
\end{lstlisting}
...
C file: 
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q2-1.C
\end{lstlisting}

\item
Load gau.dat in python and plot the empirical CDF of $X$ using the samples in gau.dat. What properties does a CDF have?\\
\solution The CDF of $X$ is plotted in Fig 2.2
using the code below
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q2-2.py
\end{lstlisting}
...
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q2-3.py
\end{lstlisting}
\begin{figure}[!h]
\centering
...
C file:
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q2-4.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q3-1.c
\end{lstlisting}

The CDF of $V$ is plotted in Fig. 3.1 using the code below
\begin{lstlisting}
    https://github.com/TushitaSharva/PRV_2022/blob/main/Manual/Codes/Q3-1.py
\end{lstlisting}

\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth]{custom_cdf.png}
\caption{The CDF of $X$}
\label{fig:3.1}
\end{figure}
